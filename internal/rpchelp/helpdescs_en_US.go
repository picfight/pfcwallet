...
var helpDescsEnUS = map[string]string{
	...
	"getbalance--result0":    "The balance of 'account' valued in picfightcoin",
	"getbalance--result1":    "The balance of all accounts valued in picfightcoin",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in picfightcoin",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in picfightcoin",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in picfightcoin",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and picfightcoin amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in picfightcoin",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in picfightcoin",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in picfightcoin",
	...
	"listtransactionsresult-amount":             "The value of the transaction output valued in picfightcoin",
	...
	"listunspentresult-amount":        "The amount of the output valued in picfightcoin",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in picfightcoin",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in picfightcoin to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in picfightcoin",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in picfightcoin",
	...
	"settxfee-amount":    "The new fee increment valued in picfightcoin",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in picfightcoin.",
