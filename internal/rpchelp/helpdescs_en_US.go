...
var helpDescsEnUS = map[string]string{
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in picfight coins",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in picfight coins",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in picfight coins",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and picfight amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in picfight coins",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in picfight coins",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in picfight coins",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in picfight coins",
	...
	"listunspentresult-amount":        "The amount of the output valued in picfight coins",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in picfight coins",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in picfight coins to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in picfight coins",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in picfight coins",
	...
	"sendtomultisig-amount":      "Amount to send to the payment address valued in picfight coins",
	...
	"settxfee-amount":    "The new fee per kB of the serialized tx size valued in picfight coins",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in picfight coins.",
	...
	"getwalletfee--result0":  "Current tx fee (in PFC)",
	...
	"purchaseticket-ticketfee":          "The transaction fee rate (PFC/kB) to use (overrides fees set by the wallet config or settxfee RPC)",
	...
	"setticketfee-fee":       "The new fee per kB of the serialized tx size valued in picfight coins",
