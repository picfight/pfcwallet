...
// interface.
func (s *Syncer) LoadTxFilter(ctx context.Context, reload bool, addrs []pfcutil.Address, outpoints []wire.OutPoint) error {
	s.filterMu.Lock()
...
func (s *Syncer) StakeDifficulty(ctx context.Context) (pfcutil.Amount, error) {
