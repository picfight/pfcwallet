...
pfcwallet will not drop transaction history by itself, as this is something that
...
```
$ cd $GOPATH/src/github.com/picfight/pfcwallet/cmd/dropwtxmgr
$ go get
```
...
```
$ dropwtxmgr
Database path: /home/username/.pfcwallet/mainnet/wallet.db
Drop all pfcwallet transaction history? [y/N] y
...
```
$ dropwtxmgr --db ~/.pfcwallet/testnet/wallet.db
Database path: /home/username/.pfcwallet/testnet/wallet.db
Drop all pfcwallet transaction history? [y/N] y
Dropping wtxmgr namespace
```

After dropping transaction history, pfcwallet may be restarted and a full rescan
will be triggered to sync the wallet:

```
$ pfcwallet
14:05:31 2015-04-13 [INF] PFCW: No recorded transaction history -- needs full rescan
...
