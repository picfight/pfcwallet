...
management of the wallet and its connection to the Picfightcoin network.  It has no
...
start the pfcd RPC client.  This RPC client is used for wallet syncing and
publishing transactions to the Picfightcoin network.
...
the Picfightcoin network.  If the transaction spends any of the wallet's unspent
