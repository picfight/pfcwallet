// Package rpctest contains tests for pfcwallet's RPC server and a harness used
// to facilitate the tests by setting up a temporary Simnet node and wallet. The
// RPC client implementation in pfcrpcclient is used exclusively to test the RPC
...
//    3. High balance to maintain (2000000 PFC).
