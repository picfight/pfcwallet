...
// Harness fully encapsulates an active pfcd process, along with an embedded
// pfcwallet to provide a unified platform for creating RPC-driven integration
// tests involving pfcd. The active pfcd node will typically be run in simnet
...
// spends. The active pfcd process is fully managed by Harness, which handles
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// Start pfcwallet. This spawns a new process which will be managed
	...
	// Get a new address from the wallet to be set with pfcd's --miningaddr
...
// pfcd process belonging to this Harness instance. If the initial connection
