...
// walletTestConfig contains all the args, and data required to launch a pfcwallet process
...
// command returns the exec.Cmd which will be used to start the pfcwallet
// process.
...
// to connect to the pfcwallet process that is launched via Start().
...
// process, and as the base for the log and data directories for pfcwallet.
...
// Start creates a new pfcwallet process, and writes its pid in a file reserved
...
// Stop interrupts the running pfcwalletTest process process, and waits until it exits
