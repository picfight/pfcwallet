...
type config struct {
	...
	TestNet3      bool                    `long:"testnet" description:"Use the test Picfightcoin network (version 3) (default mainnet)"`
	...
	Username               string                  `short:"u" long:"username" description:"Username for legacy RPC and pfcd authentication (if pfcdusername is unset)"`
	Password               string                  `short:"P" long:"password" default-mask:"-" description:"Password for legacy RPC and pfcd authentication (if pfcdpassword is unset)"`
