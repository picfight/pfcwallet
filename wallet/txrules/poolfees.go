...
func StakePoolTicketFee(stakeDiff pfcutil.Amount, relayFee pfcutil.Amount,
	height int32, poolFee float64, params *chaincfg.Params) pfcutil.Amount {
	...
	return pfcutil.Amount(num.Int64())
}
