...
type InputSource struct {
	source func(pfcutil.Amount) (pfcutil.Amount, []*wire.TxIn, [][]byte, error)
}
...
func (s *InputSource) SelectInputs(target pfcutil.Amount) (pfcutil.Amount, []*wire.TxIn, [][]byte, error) {
...
func (s *Store) MakeInputSource(ns, addrmgrNs walletdb.ReadBucket, account uint32, minConf, syncHeight int32) InputSource {
	...
	f := func(target pfcutil.Amount) (pfcutil.Amount, []*wire.TxIn, [][]byte, error) {
