...
func (m *mockChainClient) Rescan(*chainhash.Hash, []pfcutil.Address,
	map[wire.OutPoint]pfcutil.Address) error {
	return nil
}

func (m *mockChainClient) NotifyReceived([]pfcutil.Address) error {
	return nil
}
