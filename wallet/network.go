...
// Peer provides wallets with a subset of PicFight network functionality available
// to a single peer.
type Peer interface {
...
// NetworkBackend provides wallets with PicFight network functionality.  Some
...
type NetworkBackend interface {
	Peer
	LoadTxFilter(ctx context.Context, reload bool, addrs []pfcutil.Address, outpoints []wire.OutPoint) error
	...
	StakeDifficulty(ctx context.Context) (pfcutil.Amount, error)
}
