...
func (w *Wallet) LiveTicketHashes(chainClient *pfcrpcclient.Client, includeImmature bool) ([]chainhash.Hash, error) {
...
// pruned tickets.
func (w *Wallet) TicketHashesForVotingAddress(votingAddr pfcutil.Address) ([]chainhash.Hash, error) {
...
func (w *Wallet) AddTicket(ticket *wire.MsgTx) error {
	...
	err = walletdb.Update(w.db, func(tx walletdb.ReadWriteTx) error {
		...
		err := w.StakeMgr.InsertSStx(stakemgrNs, pfcutil.NewTx(ticket))
		if err != nil {
			return err
		}
...
// revocations.
func (w *Wallet) RevokeTickets(chainClient *pfcrpcclient.Client) error {
